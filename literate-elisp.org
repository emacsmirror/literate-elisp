...
- [[#implementation][Implementation]]
  ...
  - [[#lexical-binding-cookie-support-for-org-files][lexical-binding cookie support for .org files]]
...
Since Emacs 30, =get_lexical_binding= falls through to the Lisp variable
...
Install the hook.  The =boundp= check makes this a no-op on Emacs < 30; the =not eq=
